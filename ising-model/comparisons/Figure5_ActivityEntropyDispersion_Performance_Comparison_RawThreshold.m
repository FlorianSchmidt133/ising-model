%% =========================================================================
%% Fig 5: Entropy & Dispersion Performance Comparison - Hit vs Miss (Raw Threshold Version)
%% =========================================================================
...
% Frame windows for temporal analysis
FrameWindow_Baseline = 1:60;   % Pre-stimulus baseline period
FrameWindow_Stimulus = 81:90;  % Stimulus presentation period
...
%% =========================================================================
%% Section 1.1: Global statistics (NOT NEEDED for raw thresholds)
%% =========================================================================
% NOTE: Using absolute raw threshold (no per-animal or global normalization)
% This section has been removed as it calculated z-score normalization statistics
    ...
    if isfield(Grid40.(conditionIndividual).AllNeurons(r), 'P1')
        ...
        if ~isempty(gridData_P1)
            ...
            if ~isempty(hitTrialIndices) && length(hitTrialIndices) > 0
                [ent_raw_P1_Hit, ent_rz_P1_Hit, ent_tz_P1_Hit, entZ_raw_P1_Hit, entZ_rz_P1_Hit, entZ_tz_P1_Hit, ent_bin_P1_Hit] = ...
                    calculate_entropy_from_grid(gridData_P1_Hit, gridDimensions, raw_activity_threshold);
                ...
                [disp_raw_P1_Hit, disp_rz_P1_Hit, disp_tz_P1_Hit, dispZ_raw_P1_Hit, dispZ_rz_P1_Hit, dispZ_tz_P1_Hit, disp_bin_P1_Hit] = ...
                    calculate_dispersion_from_grid(gridData_P1_Hit, gridDimensions, raw_activity_threshold);
                ...
                if include_MoransI
                    morans_bin_P1_Hit = calculate_moransI_BIN(gridData_P1_Hit, gridDimensions, raw_activity_threshold);
                    MoransI_Grid_Hit.(condition).Position1.RecordingMoransI_BIN{end+1} = morans_bin_P1_Hit;
                end
            end

            % Calculate entropy for Miss trials
            if ~isempty(missTrialIndices) && length(missTrialIndices) > 0
                [ent_raw_P1_Miss, ent_rz_P1_Miss, ent_tz_P1_Miss, entZ_raw_P1_Miss, entZ_rz_P1_Miss, entZ_tz_P1_Miss, ent_bin_P1_Miss] = ...
                    calculate_entropy_from_grid(gridData_P1_Miss, gridDimensions, raw_activity_threshold);
                ...
                [disp_raw_P1_Miss, disp_rz_P1_Miss, disp_tz_P1_Miss, dispZ_raw_P1_Miss, dispZ_rz_P1_Miss, dispZ_tz_P1_Miss, disp_bin_P1_Miss] = ...
                    calculate_dispersion_from_grid(gridData_P1_Miss, gridDimensions, raw_activity_threshold);
                ...
                if include_MoransI
                    morans_bin_P1_Miss = calculate_moransI_BIN(gridData_P1_Miss, gridDimensions, raw_activity_threshold);
                    MoransI_Grid_Miss.(condition).Position1.RecordingMoransI_BIN{end+1} = morans_bin_P1_Miss;
                end
            end
            ...
            if MissNonresponsive == 2 && ~isempty(nonrespTrialIndices) && length(nonrespTrialIndices) > 0
                ...
                [ent_raw_P1_Nonresp, ent_rz_P1_Nonresp, ent_tz_P1_Nonresp, entZ_raw_P1_Nonresp, entZ_rz_P1_Nonresp, entZ_tz_P1_Nonresp, ent_bin_P1_Nonresp] = ...
                    calculate_entropy_from_grid(gridData_P1_Nonresp, gridDimensions, raw_activity_threshold);
                ...
                [disp_raw_P1_Nonresp, disp_rz_P1_Nonresp, disp_tz_P1_Nonresp, dispZ_raw_P1_Nonresp, dispZ_rz_P1_Nonresp, dispZ_tz_P1_Nonresp, disp_bin_P1_Nonresp] = ...
                    calculate_dispersion_from_grid(gridData_P1_Nonresp, gridDimensions, raw_activity_threshold);
                ...
                if include_MoransI
                    morans_bin_P1_Nonresp = calculate_moransI_BIN(gridData_P1_Nonresp, gridDimensions, raw_activity_threshold);
                    MoransI_Grid_Nonresponsive.(condition).Position1.RecordingMoransI_BIN{end+1} = morans_bin_P1_Nonresp;
                end
            end
        end
    end
    ...
    if isfield(Grid40.(conditionIndividual).AllNeurons(r), 'P3')
        ...
        if ~isempty(gridData_P3)
            ...
            if ~isempty(hitTrialIndices_P3) && length(hitTrialIndices_P3) > 0
                [ent_raw_P3_Hit, ent_rz_P3_Hit, ent_tz_P3_Hit, entZ_raw_P3_Hit, entZ_rz_P3_Hit, entZ_tz_P3_Hit, ent_bin_P3_Hit] = ...
                    calculate_entropy_from_grid(gridData_P3_Hit, gridDimensions, raw_activity_threshold);
                ...
                % Calculate dispersion for Hit trials
                [disp_raw_P3_Hit, disp_rz_P3_Hit, disp_tz_P3_Hit, dispZ_raw_P3_Hit, dispZ_rz_P3_Hit, dispZ_tz_P3_Hit, disp_bin_P3_Hit] = ...
                    calculate_dispersion_from_grid(gridData_P3_Hit, gridDimensions, raw_activity_threshold);
            ...
            if ~isempty(missTrialIndices_P3) && length(missTrialIndices_P3) > 0
                [ent_raw_P3_Miss, ent_rz_P3_Miss, ent_tz_P3_Miss, entZ_raw_P3_Miss, entZ_rz_P3_Miss, entZ_tz_P3_Miss, ent_bin_P3_Miss] = ...
                    calculate_entropy_from_grid(gridData_P3_Miss, gridDimensions, raw_activity_threshold);
                ...
                % Calculate dispersion for Miss trials
                [disp_raw_P3_Miss, disp_rz_P3_Miss, disp_tz_P3_Miss, dispZ_raw_P3_Miss, dispZ_rz_P3_Miss, dispZ_tz_P3_Miss, disp_bin_P3_Miss] = ...
                    calculate_dispersion_from_grid(gridData_P3_Miss, gridDimensions, raw_activity_threshold);
            ...
            if MissNonresponsive == 2 && ~isempty(nonrespTrialIndices_P3) && length(nonrespTrialIndices_P3) > 0
                ...
                [ent_raw_P3_Nonresp, ent_rz_P3_Nonresp, ent_tz_P3_Nonresp, entZ_raw_P3_Nonresp, entZ_rz_P3_Nonresp, entZ_tz_P3_Nonresp, ent_bin_P3_Nonresp] = ...
                    calculate_entropy_from_grid(gridData_P3_Nonresp, gridDimensions, raw_activity_threshold);
                ...
                % Calculate dispersion for Nonresponsive trials
                [disp_raw_P3_Nonresp, disp_rz_P3_Nonresp, disp_tz_P3_Nonresp, dispZ_raw_P3_Nonresp, dispZ_rz_P3_Nonresp, dispZ_tz_P3_Nonresp, disp_bin_P3_Nonresp] = ...
                    calculate_dispersion_from_grid(gridData_P3_Nonresp, gridDimensions, raw_activity_threshold);
...
% NOTE: Only BIN for Position1 is calculated; P3 is empty
% Hit trials
...
% Frame windows defined at top of script (FrameWindow_Baseline, FrameWindow_Stimulus)
%%
...
if MissNonresponsive == 2
    ...
    plotMedianEntropyBars_Grid_Performance(Entropy_Grid_Hit, Entropy_Grid_Miss, ...
        ...
        'FrameWindow', FrameWindow_Baseline, 'Entropy_Grid_Nonresponsive', Entropy_Grid_Nonresponsive)
else
    % Two-way comparison
    plotMedianEntropyBars_Grid_Performance(Entropy_Grid_Hit, Entropy_Grid_Miss, ...
        Rec, params, condition, Skip, 'Position', Position, 'Type', Type, 'UseZScored', UseZScored, ...
        'FrameWindow', FrameWindow_Baseline)
end
...
% if MissNonresponsive == 2
%     % Three-way comparison
%     plotMedianDispersionBars_Grid_Performance(Dispersion_Grid_Hit, Dispersion_Grid_Miss, Rec, params, condition, Skip, 'Position', Position, 'Type', Type,'FrameWindow', FrameWindow_Baseline, 'Dispersion_Grid_Nonresponsive', Dispersion_Grid_Nonresponsive);
% else
%     % Two-way comparison
%     plotMedianDispersionBars_Grid_Performance(Dispersion_Grid_Hit, Dispersion_Grid_Miss, Rec, params, condition, Skip, 'Position', Position, 'Type', Type, 'FrameWindow', FrameWindow_Baseline);
% end
...
if include_MoransI
    ...
    if MissNonresponsive == 2
        ...
        plotMedianMoransIBars_Grid_Performance(MoransI_Grid_Hit, MoransI_Grid_Miss, ...
            ...
            'FrameWindow', FrameWindow_Baseline, 'MoransI_Grid_Nonresponsive', MoransI_Grid_Nonresponsive);
    else
        % Two-way comparison
        plotMedianMoransIBars_Grid_Performance(MoransI_Grid_Hit, MoransI_Grid_Miss, ...
            Rec, params, condition, Skip, 'Position', Position, 'Type', Type, 'FrameWindow', FrameWindow_Baseline);
    end

    %% 4.1b: Moran's I Distribution During Stimulus Period 
    fprintf('\n=== Creating Stimulus Period Moran''s I Comparison  ===\n');
    if MissNonresponsive == 2
        % Three-way comparison - Stimulus period
        plotMedianMoransIBars_Grid_Performance(MoransI_Grid_Hit, MoransI_Grid_Miss, ...
            Rec, params, condition, Skip, 'Position', Position, 'Type', Type, ...
            'FrameWindow', FrameWindow_Stimulus, 'MoransI_Grid_Nonresponsive', MoransI_Grid_Nonresponsive);
    else
        % Two-way comparison - Stimulus period
        plotMedianMoransIBars_Grid_Performance(MoransI_Grid_Hit, MoransI_Grid_Miss, ...
            Rec, params, condition, Skip, 'Position', Position, 'Type', Type, 'FrameWindow', FrameWindow_Stimulus);
    end
