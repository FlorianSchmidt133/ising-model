%% =========================================================================
%% Fig 5: Entropy Comparison - Grid vs Activity Data
%% =========================================================================
...
% Binarisation threshold for entropy and dispersion calculations
        ...
        if isfield(Grid40.(conditionIndividual).AllNeurons(r), 'P1')
            ...
            if ~isempty(gridData_P1)
                ...
                [ent_raw_P1, ent_rz_P1, ent_tz_P1, entZ_raw_P1, entZ_rz_P1, entZ_tz_P1, ent_bin_P1, ent_bin_an_P1, ent_bin_all_P1] = ...
                    calculate_entropy_from_grid(gridData_P1, gridDimensions, animalMean_P1, animalStd_P1, globalMean_P1, globalStd_P1, binarisation_threshold);
                ...
                [disp_raw_P1, disp_rz_P1, disp_tz_P1, dispZ_raw_P1, dispZ_rz_P1, dispZ_tz_P1, disp_bin_P1, disp_bin_an_P1, disp_bin_all_P1] = ...
                    calculate_dispersion_from_grid(gridData_P1, gridDimensions, animalMean_P1, animalStd_P1, globalMean_P1, globalStd_P1, binarisation_threshold);
                ...
                [actcells_raw_P1, actcells_rz_P1, actcells_tz_P1, actcellsZ_raw_P1, actcellsZ_rz_P1, actcellsZ_tz_P1, actcells_bin_P1, actcells_bin_an_P1, actcells_bin_all_P1] = ...
                    calculate_active_cells_from_grid(gridData_P1, gridDimensions, animalMean_P1, animalStd_P1, globalMean_P1, globalStd_P1, binarisation_threshold);
                ...
                if include_MoransI
                    morans_bin_an_P1 = calculate_moransI_BIN_AN(gridData_P1, gridDimensions, animalMean_P1, animalStd_P1, binarisation_threshold);
        ...
        if isfield(Grid40.(conditionIndividual).AllNeurons(r), 'P3')
            ...
            if ~isempty(gridData_P3)
                ...
                [ent_raw_P3, ent_rz_P3, ent_tz_P3, entZ_raw_P3, entZ_rz_P3, entZ_tz_P3, ent_bin_P3, ent_bin_an_P3, ent_bin_all_P3] = ...
                    calculate_entropy_from_grid(gridData_P3, gridDimensions, animalMean_P3, animalStd_P3, globalMean_P3, globalStd_P3, binarisation_threshold);
                ...
                [disp_raw_P3, disp_rz_P3, disp_tz_P3, dispZ_raw_P3, dispZ_rz_P3, dispZ_tz_P3, disp_bin_P3, disp_bin_an_P3, disp_bin_all_P3] = ...
                    calculate_dispersion_from_grid(gridData_P3, gridDimensions, animalMean_P3, animalStd_P3, globalMean_P3, globalStd_P3, binarisation_threshold);
                ...
                [actcells_raw_P3, actcells_rz_P3, actcells_tz_P3, actcellsZ_raw_P3, actcellsZ_rz_P3, actcellsZ_tz_P3, actcells_bin_P3, actcells_bin_an_P3, actcells_bin_all_P3] = ...
                    calculate_active_cells_from_grid(gridData_P3, gridDimensions, animalMean_P3, animalStd_P3, globalMean_P3, globalStd_P3, binarisation_threshold);
